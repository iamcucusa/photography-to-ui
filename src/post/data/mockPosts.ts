...
export const mockPosts: PostEntity[] = [
  {
    ...
    content: {
      ...
      caption: 'Speed creates motion. Systems create progress. The runner moves alone, while the platform carries many. Which path builds trust? Which path scales?',
    },
  },
  {
      ...
      slides: [
        {
          ...
          cta: 'Swipe left →',
          emphasizedWords: ['frontend best practices', 'multi-team scale', 'global entropy', 'systemic'],
          image: {
        ...
        },
        {
          ...
          subhead: 'Tokens bypassed. Components duplicated. Styles overridden. Each decision seems isolated. Together, they fragment the system.',
          cta: 'Swipe left →',
          image: {
